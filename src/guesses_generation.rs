...
use crate::{
    assignment::Assignment, assignment_constraint::AssignmentConstraint, guess_group::GuessGroup,
};
...
pub fn generate_groups_of_cell_guesses(
    cell_constraints: &[AssignmentConstraint],
) -> Vec<GuessGroup> {
...
pub fn generate_group_of_number_guesses(
    cell_constraints: &[AssignmentConstraint],
) -> Vec<GuessGroup> {
    let mut result: Vec<GuessGroup> = Vec::new();
